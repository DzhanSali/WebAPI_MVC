            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "People",
                        principalColumn: "Id");
                    // Although it is logical to delete this table if corresponding person should be deleted, 
                    // I will do the opposite since the way it is now gives error of type "multiple cascade paths"
                        //onDelete: ReferentialAction.Cascade);
                });
